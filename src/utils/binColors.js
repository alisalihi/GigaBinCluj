...
export const buildPopupContent = (bin) => {
  ...
  return `
    <div style="font-weight:800;font-size:13px;color:#005BAA;margin-bottom:8px">${bin.name}</div>
    <div style="display:flex;justify-content:space-between;font-size:11px;color:#64748b;margin:2px 0"><span>Suburb</span><span style="color:#0f172a;font-weight:600">${bin.suburb}</span></div>
    <div style="display:flex;justify-content:space-between;font-size:11px;color:#64748b;margin:2px 0"><span>District</span><span style="color:#0f172a">${bin.district}</span></div>
    ...
    <div style="display:flex;justify-content:space-between;font-size:11px;color:#64748b;margin:2px 0"><span>Monthly volume</span><span style="color:#0f172a">${(bin.monthlyWeightKg/1000).toFixed(0)}t</span></div>
    ${trend ? `<div style="font-size:10px;color:#f59e0b;margin-top:4px;font-weight:500">${trend}</div>` : ''}
    <div style="font-size:9px;color:#94a3b8;margin-top:2px">Data: Supercom SA 2024-2026</div>
    <div style="margin-top:8px;height:5px;border-radius:4px;background:#e2e8f0;overflow:hidden">
